...
def test_transactions_by_categories(adv_transactions_list):
    ...
    assert processing.transactions_by_categories(
        adv_transactions_list, ["Перевод со счета на счет", "Перевод организации", "Погашение кредита"]
    ) == {"Перевод организации": 2, "Перевод со счета на счет": 2, "Погашение кредита": 0}


def test_transactions_by_rubles(adv_transactions_list):
    """Тестирование работы функции фильтрации по валюте: RUB"""
    assert processing.transactions_by_currency(adv_transactions_list, "RUB") == [
        {
            "id": 873106923,
            "state": "EXECUTED",
            "date": "2019-03-23T01:09:46.296404",
...
def test_transactions_by_usd(adv_transactions_list):
    """Тестирование работы функции фильтрации по валюте: USD"""
    assert processing.transactions_by_currency(adv_transactions_list, "USD") == [
        {
            "id": 939719570,
            "state": "EXECUTED",
...
def test_transactions_by_eur(adv_transactions_list):
    """Тестирование работы функции фильтрации по валюте: EUR"""
    assert processing.transactions_by_currency(adv_transactions_list, "EUR") == []
