...
def get_mask_card_number(card_number: str) -> str:
    ...
    if card_number.isdigit() and len(card_number) == 16:
        ...
        logger.error(
            f"Функция маскирования номера карты завершилась ошибкой: Некорректный номер карты: {card_number}"
        )
...
def get_mask_account(account_number: str) -> str:
    ...
    logger.info(
        f"Вызвана функция маскирования номера банковского счёта: {account_number}"
    )
